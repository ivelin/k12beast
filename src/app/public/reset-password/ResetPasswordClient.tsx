// File path: src/app/public/reset-password/ResetPasswordClient.tsx
// Client component for K12Beast reset password page, handling password reset flow
// Includes form with password confirmation and visibility toggles
